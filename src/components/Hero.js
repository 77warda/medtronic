...
export default function Hero() {
  return (
    <div>
      ...
      {/* mobile section  */}
      <div className="h-[80vh] md:h-screen lg:h-screen w-full relative flex lg:flex-row flex-col lg:items-center items-start justify-start lg:justify-center px-0 lg:px-48">
        <img
          src={bgImage} // Default image for larger screens
          alt="Devices"
          className="static lg:absolute -top-3 w-full h-[55vh] lg:h-[90vh] lg:block md:block hidden" // Hide on small screens, visible on lg and above
        />
        <img
          src={hero} // Image for mobile screens
          alt="Devices"
          className="md:hidden block w-full h-[45vh] md:h-[65vh] lg:h-[90vh] lg:hidden" // Hide on large screens, visible on small screens
        />
